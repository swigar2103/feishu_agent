...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2026.05.01-eea359f-$(date +%s)"
...
DOWNLOAD_URL="https://downloads.cursor.com/lab/2026.05.01-eea359f/${OS}/${ARCH}/agent-cli-package.tar.gz"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2026.05.01-eea359f"
...
ln -s ~/.local/share/cursor-agent/versions/2026.05.01-eea359f/cursor-agent ~/.local/bin/agent
ln -s ~/.local/share/cursor-agent/versions/2026.05.01-eea359f/cursor-agent ~/.local/bin/cursor-agent
