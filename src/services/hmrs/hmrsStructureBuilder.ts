...
export const HMRS_FOLDER_NAMES = {
  ...
  proposalRoom: "方案模板房间",
  dailyReportRoom: "日报模板房间",
  bizWeeklyRoom: "业务周报模板房间",
...
export function buildRequiredFolders(): string[] {
  return [
    ...
    `${HMRS_FOLDER_NAMES.templatesWing}/${HMRS_FOLDER_NAMES.dailyReportRoom}/${HMRS_FOLDER_NAMES.structureDrawer}`,
    `${HMRS_FOLDER_NAMES.templatesWing}/${HMRS_FOLDER_NAMES.dailyReportRoom}/${HMRS_FOLDER_NAMES.examplesDrawer}`,
    `${HMRS_FOLDER_NAMES.templatesWing}/${HMRS_FOLDER_NAMES.bizWeeklyRoom}/${HMRS_FOLDER_NAMES.structureDrawer}`,
    `${HMRS_FOLDER_NAMES.templatesWing}/${HMRS_FOLDER_NAMES.bizWeeklyRoom}/${HMRS_FOLDER_NAMES.examplesDrawer}`,
